...
export function TableHead({ className, children, ...props }: React.ThHTMLAttributes<HTMLTableCellElement>) { return <th className={cn('px-3 py-3 text-left lens-meta font-bold uppercase tracking-[0.1em] text-tv-muted sm:px-4 sm:tracking-[0.12em]', className)} {...props}>{children}</th>; }
