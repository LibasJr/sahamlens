...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'pemindai-harga', name: 'Pemindai Harga Masuk', subtitle: 'Level masuk, Stop Loss, dan sasaran dari arsip harga', path: '/pemindai-harga', icon: Crosshair, guest: true },
    ],
  },
  {
    id: 'tools',
...
export default function Sidebar() {
  ...
  // Akun admin tetap dapat melihat menu Admin Panel di desktop maupun web.
  const role: 'guest' | 'trial' | 'admin' = (hasAdminAccess || effectiveRole === 'admin')
    ? 'admin'
    : effectiveRole;
