...
function App() {
  ...
  return <div className="terminal">
    ...
    <main className="main"><header className="header"><div><p className="eyebrow">MONDAY, 30 AUGUST 2026</p><h1>{active}</h1></div><div className="actions"><button className="search">⌕&nbsp; Search stock <kbd>⌘ K</kbd></button><button className="icon">◔</button><button className="icon">⚙</button></div></header>
