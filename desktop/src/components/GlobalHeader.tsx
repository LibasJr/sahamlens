...
export function GlobalHeader({ apiStatus, mode, onModeChange, onSearch, onToggleWatchlist, onToggleInsight }: { apiStatus: 'checking' | 'online' | 'offline'; mode: ExperienceMode; onModeChange: (mode: ExperienceMode) => void; onSearch: (symbol: string, name?: string) => void; onToggleWatchlist: () => void; onToggleInsight: () => void }) {
