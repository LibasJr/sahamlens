...
export const desktopFeatures: DesktopFeature[] = [
  ...
  { id: 'recommendations', label: 'Recommendations', endpoint: s => `/api/recommendations?symbols=${encodeURIComponent(s || 'BBCA.JK')}`, note: 'Rekomendasi tervalidasi server.', needsSymbol: true },
