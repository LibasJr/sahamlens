...
const PRODUCT_FEATURES: ProductFeature[] = [
  ...
  { pattern: /\b(transparansi|transparency)\b/, name: 'Transparansi Validasi LensRadar', function: 'meninjau bukti forward per bucket LensScore, uji signifikansi, dan rekonsiliasi harga lintas sumber', usage: 'panel internal - buka Admin → Transparansi Validasi LensRadar; menu ini tidak tersedia untuk pengguna umum', result: 'evidence validasi model dan status point-in-time', limitation: 'angkanya tidak dipublikasikan, dan bukti historis tidak menjamin performa ke depan' },
