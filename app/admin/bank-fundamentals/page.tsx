...
import { getBankMetricEvidenceAdminSummary } from '@/modules/fundamental/repository/bank-fundamental.repository';
...
export default async function BankFundamentalsAdminPage() {
  ...
  const data=await getBankMetricEvidenceAdminSummary();
