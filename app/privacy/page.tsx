...
export default function PrivacyPage(){return <main className="mx-auto max-w-3xl px-4 py-10 text-tv-text"><Link href="/home" className="text-sm text-tv-blue">← Kembali</Link><h1 className="mt-5 font-heading text-3xl font-bold">Kebijakan Privasi SahamLens</h1><div className="mt-6 space-y-5 text-sm leading-7 text-tv-muted">
...
<p>Feedback LensAI dapat menyimpan prompt dan jawaban yang secara eksplisit dinilai pengguna untuk evaluasi kualitas. Default retensinya 180 hari. Jangan masukkan rahasia, password, atau data pribadi sensitif ke prompt.</p>
