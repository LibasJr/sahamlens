...
export const metadata = {
  ...
  description:
    'Level masuk, henti rugi, dan sasaran yang dihitung langsung dari arsip harga SahamLens: penutupan terendah/tertinggi 20 sesi dan volatilitas penutupan-ke-penutupan.',
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-tv-muted">
          {isEn
            ...
            : 'Tiga angka per emiten, semuanya dihitung dari arsip harga SahamLens sendiri: level masuk, henti rugi, dan sasaran. Tidak ada yang berasal dari panggilan luar, taksiran analis, atau nilai tambalan.'}
        </p>
        ...
        <Card as="section" padding="none" radius="xl" elevation="none" highlight={false} overflow="visible" className="mb-6 mt-4 border-tv-border p-5">
          ...
          <ul className="mt-2 space-y-1 text-sm text-tv-muted">
            ...
            <li>
              • {isEn ? 'Stop' : 'Henti rugi'} = {isEn ? 'entry level minus' : 'level masuk dikurangi'} {data.options.stopVolatilityMultiple}{' '}
                ...
                <table className="w-full text-left text-sm">
                  <thead className="text-xs uppercase tracking-wide text-tv-muted">
                    <tr>
                      ...
                      <th className="py-2 pr-3">{isEn ? 'Stop' : 'Henti rugi'}</th>
          ...
          <ul className="mt-3 space-y-1 text-sm text-tv-muted">
            ...
            <li>
              • {isEn
                ...
                : 'Level dihitung hanya dari penutupan; arsip tidak punya high/low intraday, jadi henti rugi berbasis ATR tidak bisa diproduksi secara jujur.'}
            </li>
          </ul>
        </Card>
      </div>
